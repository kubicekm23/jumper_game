...
def first_map():
    ...
    obstacle8 = Obstacle(obstacle7.rect.x + 232, obstacle7.rect.y + 107, 138, 23)
    #obstacle8 = Obstacle(2528, 608, 138, 23)
    obstacle9 = Obstacle(obstacle7.rect.x + 28, obstacle7.rect.y + 202, 138, 23)
    #obstacle9 = Obstacle(2324, 499, 138, 23)
    obstacle10 = Obstacle(obstacle7.rect.x - 376, obstacle7.rect.y + 282, 138, 23)
    #obstacle10 = Obstacle(1920, 419, 348, 50)
    obstacle11 = Obstacle(2111, 271, 138, 23)
    obstacle12 = Obstacle(1900, 132, 138, 23)
    obstacle13 = Obstacle(1672, -87, 211, 30)
    obstacle14 = Obstacle(1487, -215, 138, 23)
    obstacle15 = Obstacle(1677, -371, 138, 23)
    obstacle16 = Obstacle(1479, -526, 138, 23)
    obstacle17 = Obstacle(1677, -686, 138, 23)
    obstacle18 = Obstacle(1487, -863, 138, 23)      # has star2
    obstacle19 = Obstacle(1670, -1020, 138, 23)
    obstacle20 = Obstacle(1832, -1176, 138, 23)
    obstacle21 = Obstacle(2027, -1309, 138, 23)
    obstacle22 = Obstacle(2222, -1409, 138, 23)
    obstacle23 = Obstacle(2466, -1419, 138, 23)
    obstacle24 = Obstacle(2687, -1419, 138, 23)
    obstacle25 = Obstacle(2807, -1419, 138, 23)
    obstacle26 = Obstacle(3022, -1419, 348, 50)     # has door
