...
def first_map():
    ...
    obstacle18 = Obstacle(1487, -868, 138, 23)      # has star2
    ...
    obstacle23 = Obstacle(2466, -1424, 138, 23)
    obstacle24 = Obstacle(2687, -1424, 138, 23)
    obstacle25 = Obstacle(2807, -1424, 138, 23)
    obstacle26 = Obstacle(3022, -1424, 348, 50)     # has door
