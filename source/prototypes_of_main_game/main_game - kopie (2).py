...
def movement(player, obstacles):
    ...
    for obstacle in obstacles:
        ...
        if player_rect.colliderect(obstacle.rect):
            ...
            if (player_rect.top < obstacle.rect.top and player_rect.right > obstacle.rect.left + 4 and
            ...
            # If there is a collision with the left-top side of the obstacle
            elif player_rect.centery - (player_height / 2) < obstacle.rect.bottomleft[1] and player_rect.centery \
                    + (player_height / 2) > obstacle.rect.topleft[1] and facing_right and not player_rect.y + player_height < obstacle.rect.y:
